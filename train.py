...
def main(args):
    ...
    dataset = ConcatDataset([
                                    ...
                                    data_modules[2].data_train,
                                    data_modules[3].data_train,
                                    data_modules[4].data_train,
                                    data_modules[5].data_train,
                                    data_modules[6].data_train,
                                    data_modules[7].data_train,
                                    data_modules[7].data_unlabeled,
                                    data_modules[8].data_unlabeled, 
                                    data_modules[9].dataset,
                                    data_modules[10].dataset,
                                    data_modules[11].dataset,
                                    data_modules[0].data_val,
                                    data_modules[1].data_val,
                                    data_modules[2].data_val,
                                    data_modules[3].data_val,
                                    data_modules[4].data_val,
                                    data_modules[5].data_val,
                                    data_modules[6].data_val
                                    ])
    ...
    for epoch in range(args.epochs):
        ...
        for i, (x, y, _) in enumerate(progress_bar):
            x = x.to(device)
            y = y.long().to(device)
            with torch.no_grad():
